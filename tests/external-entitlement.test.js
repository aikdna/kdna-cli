...
test('external entitlement keeps private keys and grant out of metadata and loads a Capsule', () => {
  ...
  for (const id of ['../src/paths', '../src/secret-store', '../src/external-entitlement', '../src/package-store']) {
